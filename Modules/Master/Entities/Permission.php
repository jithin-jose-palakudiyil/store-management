...
class Permission extends Model
{
    ...
    protected static $logAttributes = ['name','slug','module_id','is_master','is_store','status'];
    ...
    {
        return "You have {$eventName} a permission";
    }
    ...
    public function hasModule() {
        return $this->hasOne("Modules\Master\Entities\Module","id","module_id");
    }
