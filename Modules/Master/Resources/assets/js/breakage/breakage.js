                        ...
                        success: function (data) { 
                            if (data.length === 0) { 
                                ...
                                var resp = $.map(data,function(obj){ 
                                   return { label: obj.name+' - '+obj.unique_id, value: obj.id  ,"pivot_id": obj.pivot_id,"amount": obj.amount  } ;
                               }); 
                               response(resp);
                            }  
                        }
                    ...
                    },
                    {
                        ...
                        {   
                            ...
                            if( typeof(gatePassBtn) != "undefined" && gatePassBtn && (full.step=="1" || full.step=="2" || full.step=="3") && full.is_status==0){
                                var gate_pass_url=base_url+'/'+master_prefix+'/gate-pass'+'/?breakage='+full.id;
