var url_prefix ='maintenance-type';
$(function() 
{  
...
//            targets: [ 5 ]
      ...
      ({
        ...
        columns: [ 
                    ...
                    {
                        data: "days", sortable: false,
                        render: function (data, type, full) {  return  full.days; } 
                    },
                    {
...
/* ************************************************************************** */ 
    ...
    if($('#maintenance_type_form').length)
    { 
        ...
        $("#maintenance_type_form").validate({
            ...
            rules: {  
                        ...
                        'days':{required:true, normalizer: function(value) { return $.trim(value);  },digits: true },
