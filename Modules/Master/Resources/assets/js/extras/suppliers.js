      ...
      ({
        ...
        columns: [ 
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {  return  full.phone; } 
                    },
                    {
    ...
    { 
        ...
        $("#_form").validate({
            ...
            rules: {  
                        ...
                        'email':{required:true, normalizer: function(value) { return $.trim(value);  },maxlength: 255,chkEmail:true },
                        'phone':{required:true, normalizer: function(value) { return $.trim(value);  },minlength: 10,maxlength: 12,digits:true },
                        'address':{required:true, normalizer: function(value) { return $.trim(value);  },minlength: 10 },
