...
//            targets: [ 5 ]
      ...
      ({
        ...
        columns: [ 
                    ...
                    {
                        data: "null","searchable": false, sortable: false,
                        render: function (data, type, full) {  return  full.has_one_maintenance_type.name; } 
                    },
                    {
    ...
    { 
            $( "#item_name" ).autocomplete({
                ...
                source: function(request, response) {
                    $.ajax({
                    url:base_url+'/'+master_prefix+'/maintenance-autocomplete', 
                    ...
                    success: function(data){
                       var resp = $.map(data,function(obj){ 
                           return { label: obj.name+' - '+obj.unique_id, name: obj.name, value: obj.id , unique_id: obj.unique_id, has_maintance: obj.has_maintance  } ;
                       }); 
                    ...
                    if(ui.item.has_maintance){ $("#unique_id").attr('style',  'color:red'); }else{$("#unique_id").attr('style',  'color:#333'); }
                    return false;
            },
         ...
         $( "#company_name" ).autocomplete({
                ...
                source: function(request, response) {
                    $.ajax({
                    url:base_url+'/'+master_prefix+'/maintenance-autocomplete-suppliers', 
                    ...
                    success: function(data){
                       var resp = $.map(data,function(obj){ 
                           return { label: obj.name, email: obj.email, phone: obj.phone , id: obj.id  } ;
                       }); 
                    ...
                    $("#contact_number").val(ui.item.phone); 
//                    $("#item_id").val(ui.item.value); 
//                    $("#item_name").val(ui.item.name); 
                    return false;
            },
        ...
        $("#_form").validate({
            ...
            rules: {  
                        ...
                        'company_name':{required:true, normalizer: function(value) { return $.trim(value);  },maxlength: 255 },
                        ...
                        'maintenance_type_id':{required:true, normalizer: function(value) { return $.trim(value);  },maxlength: 12 },
                        'status':{required:true, normalizer: function(value) { return $.trim(value);  } },
                    }
        }); 
        
        $(document.body).on("change","#maintenance_type_id",function()
        {   

            var maintenance_type_id =$(this).val(); 
...
//
            var url_form=base_url+'/'+master_prefix+'/'+url_prefix+'/maintenance-status-update';
            $.ajax
            ({
                type: 'POST',
                url: url_form,
                ...
                data :{'date':date,'status':status,'comments':comments,'maintenance_id':maintenance_id,'completion_date':completion_date},
...
/* ************************************************************************** */ 
    ...
    function  maintenance_type(maintenance_type_id,maintenance_id=null)
    {
        ...
        var url=base_url+'/'+master_prefix+'/'+url_prefix+'/get-maintenance-days/'+maintenance_type_id;
        $.ajax
            ({
                type: 'GET',
                url: url,
