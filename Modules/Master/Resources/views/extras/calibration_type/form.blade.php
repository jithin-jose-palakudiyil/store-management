        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="name" name="name"  placeholder="Enter Name" value="{{(isset($CalibrationType['name']) && $CalibrationType['name']) ? $CalibrationType['name']:old('name')}}" >
                    @if($errors->has('name'))
            ...
            <div class="col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="days" name="days"  placeholder="Days" value="{{(isset($CalibrationType['days']) && $CalibrationType['days']) ? $CalibrationType['days']:old('days')}}" >
                    @if($errors->has('days'))
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="status" id="status" data-placeholder="status" class="select " data-minimum-results-for-search="-1">
                        <option></option> 
                        <option value="1"  @if(isset($CalibrationType['status']) && $CalibrationType['status']==1) selected @endif >Active</option>
                        <option value="2" @if(isset($CalibrationType['status']) && $CalibrationType['status']==2) selected @endif>Inactive</option> 
                     </select>
                    <div id="status_err">
