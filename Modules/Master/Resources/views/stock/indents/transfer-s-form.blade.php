...
{!! Form::model($indent, ['method' => 'PATCH', 'route' => ['stock.indents_store_transfer_action', $indent->id],'class'=>'form-valide','id'=>'indents_transfer_action','enctype'=>'multipart/form-data']) !!}     
<?php endif; ?>    
                                     ...
                                     <div class="col-md-2 ">
                                         <div class="form-group"> 
                                              <label class="checkbox-inline">
                                                  <input {{$disabled}} {{$checked}}  type="checkbox" name='approve[{{$value->id}}][{{$values->pivot_store_id}}]' class="{{$class}}"   >
                                                 {{$values->unique_id}}
                                             </label>
                                         </div>
                                     </div>
